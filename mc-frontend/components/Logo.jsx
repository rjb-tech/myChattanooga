...
export const Logo = ({ isDark, toggleMobileUserPanel, panelExpanded }) => {
  const dynamicLogo = isDark===true ? logo_dark : logo
  return (
    <div className='w-2/3 sm:w-2/6 xl:w-1/4 relative z-[100]' onClick={() => {if (panelExpanded===true) {toggleMobileUserPanel()}}}>
      <Link href="/">
        <a>
