  ...
  return (
    <div className="w-4/6 md:w-5/6 mx-auto pb-4 md:pt-2">
      ...
      <div className="py-1 md:py-2">
        <motion.button 
          whileTap={{ scale: 0.9 }}
          className="block flex-auto mx-auto border-y h-10 rounded-lg w-full hover:border-[#F7BCB1] border-[#222] dark:border-[#fff]"
          onClick={async () => 
            {
      ...
      <div className="py-2">
        <motion.button 
          whileTap={{ scale: 0.9 }}
          className="flex-auto mx-auto border-y h-10 rounded-lg w-full hover:border-[#F7BCB1] border-[#222] dark:border-[#fff]"
