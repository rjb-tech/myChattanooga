...
export const MobileUserPanel = ({ 
    ...
    return (
        <div className='flex-col items-center'>
            ...
            >
                <div className='h-fit w-full divide-y-2 py-2 flex-col flex-auto text-center bg-[#FFF] text-[#222] dark:bg-[#222] dark:text-[#FFF] z-10'>
            ...
            <motion.div
                className='h-48 fixed w-screen bg-[#FFF] text-[#222] dark:bg-[#222] dark:text-[#FFF] shadow overscroll-auto flex items-center z-10'
