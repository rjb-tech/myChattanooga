...
export const UserPanel = ({ 
  ...
  return (
    <div className='flex-auto h-fit w-5/6 flex-col flex-auto bg-[#FFF] text-[#222] dark:bg-[#222] dark:text-[#FFF] mx-auto z-50'>
      ...
      <motion.div
        className='h-fit w-full relative bg-[#FFF] text-[#222] dark:bg-[#222] dark:text-[#FFF] overscroll-auto flex-col items-center z-10'
