...
export const WeatherStation = ({ isNight }) => {
    ...
    const [ currentWeatherCode, setCurrentWeatherCode ] = useState(600);
    ...
    const actualIcon = isDay ? SkyconType[weatherCodeMappings[currentWeatherCode].day] : SkyconType[weatherCodeMappings[currentWeatherCode].night]
    console.log(currentWeatherCode)

    return (
        <div className='flex-col mx-auto h-full'>
            <div className='flex-col h-full'>
                <div className='flex-auto text-2xl text-center'>
                    {locations[`${currentLocation}`].name}
                </div>
                <div className='flex'> 
                    <div className='w-1/2 mx-auto flex-auto py-8'>
                        <ReactSkycon 
                            icon={actualIcon}
                            size={148}
                            animate
                    ...
                    <div className=' w-1/2 text-5xl container mx-auto self-center'>
                        <div className='justify-center flex'>
                            {currentTemp}<p className='text-2xl mt-1'>&#176;F</p>
                        </div>
