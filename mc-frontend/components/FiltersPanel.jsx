    ...
    <div className="h-5/6 w-4/6 md:w-5/6 md:px-0 flex-col mx-auto pb-4">
      {filterOptions.length > 1 && <div className="py-1 md:py-2">
        <motion.button whileTap={{ scale: 0.9 }}
          ...
          id='all-button'
          className="flex-auto mx-auto border py-2 rounded-xl w-full hover:border-[#F7BCB1] border-[#F7BCB1] ring-[#F7BCB1] ring-1 border-[#222] dark:border-[#fff]"
          onClick={() => {
        ...
        return (
          <div className="py-1 md:py-2" key={currentOption}>
            <motion.button
              ...
              className= "flex-auto mx-auto border py-2 rounded-xl w-full hover:border-[#F7BCB1] border-[#222] dark:border-[#fff]"
              onClick={() => {
